...
interface IBaseHedgeExtension {
  function dynamicHedge() external;

  function userHedge() external;

  function closeHedge() external;
}

/**
 * @title SynthetixExtension
 * @author Otus
 */
contract SynthetixExtension is IBaseHedgeExtension {
  /************************************************
   ...
   */
  constructor() StrategyBase(_quoteAsset, _otusController) {}
