...
export interface OptionTokenInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [BigNumberish, OptionMarket.TradeStruct, BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "PositionMerged(uint256,uint256,tuple,tuple)": EventFragment;
    "PositionSplit(address,uint256,uint256,tuple,tuple)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "PositionMerged"): EventFragment;
...
export type PositionCreatedEvent = TypedEvent<
  [string, BigNumber, OptionToken.OptionPositionStructOutput],
  {
    owner: string;
    positionId: BigNumber;
...
export type PositionMergedEvent = TypedEvent<
  [
    BigNumber,
    BigNumber,
  ...
  {
    basePositionId: BigNumber;
    mergedPositionId: BigNumber;
    basePosition: OptionToken.OptionPositionStructOutput;
    mergedPosition: OptionToken.OptionPositionStructOutput;
  }
>;

export type PositionMergedEventFilter = TypedEventFilter<PositionMergedEvent>;
...
export type PositionSplitEvent = TypedEvent<
  ...
  ],
  {
    ...
    basePosition: OptionToken.OptionPositionStructOutput;
    newPosition: OptionToken.OptionPositionStructOutput;
  }
>;
...
export type PositionUpdatedEvent = TypedEvent<
  [BigNumber, OptionToken.OptionPositionStructOutput],
  { positionId: BigNumber; position: OptionToken.OptionPositionStructOutput }
>;
...
export interface OptionToken extends BaseContract {
  ...
  filters: {
    ...
    "PositionMerged(uint256,uint256,tuple,tuple)"(
      basePositionId?: BigNumberish | null,
      mergedPositionId?: BigNumberish | null,
      basePosition?: null,
      mergedPosition?: null
    ): PositionMergedEventFilter;
    PositionMerged(
      basePositionId?: BigNumberish | null,
      mergedPositionId?: BigNumberish | null,
      basePosition?: null,
    ...
    "PositionSplit(address,uint256,uint256,tuple,tuple)"(
      recipient?: string | null,
      basePositionId?: BigNumberish | null,
      newPositionId?: BigNumberish | null,
      basePosition?: null,
      newPosition?: null
