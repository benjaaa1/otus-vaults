...
export interface MockSynthetixInterface extends utils.Interface {
  contractName: "MockSynthetix";
  functions: {
    ...
    "setMockedKeyToAddress(bytes32,address)": FunctionFragment;
    "setMockedTradeAmount(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setMockedKeyToAddress",
...
export interface MockSynthetix extends BaseContract {
  contractName: "MockSynthetix";
