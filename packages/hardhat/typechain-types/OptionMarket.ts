...
export interface OptionMarketInterface extends utils.Interface {
  ...
  events: {
    ...
    "PositionClosed(address,uint256,uint256,uint8,uint256,bool,uint256,uint256,uint256,tuple[])": EventFragment;
    "PositionLiquidated(uint256,address,address,address,uint256,uint8,uint256,uint256,tuple,tuple[])": EventFragment;
    "PositionOpened(address,uint256,uint256,uint8,uint256,uint256,uint256,uint256,tuple[])": EventFragment;
...
export interface OptionMarket extends BaseContract {
  ...
  filters: {
    ...
    "PositionClosed(address,uint256,uint256,uint8,uint256,bool,uint256,uint256,uint256,tuple[])"(
      trader?: string | null,
    ...
    "PositionLiquidated(uint256,address,address,address,uint256,uint8,uint256,uint256,tuple,tuple[])"(
      positionId?: BigNumberish | null,
      rewardBeneficiary?: string | null,
    ...
    "PositionOpened(address,uint256,uint256,uint8,uint256,uint256,uint256,uint256,tuple[])"(
      trader?: string | null,
      strikeId?: BigNumberish | null,
      positionId?: BigNumberish | null,
      optionType?: null,
