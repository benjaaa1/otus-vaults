...
export default function Product() {
  ...
  const response = useVaultProduct(query?.vault)
        ...
        <main className="py-10">
          ...
          <div className="mx-auto max-w-3xl md:flex md:items-center md:justify-between md:space-x-5 lg:max-w-7xl">
            ...
            <div className="justify-stretch mt-6 flex flex-col-reverse space-y-4 space-y-reverse sm:flex-row-reverse sm:justify-end sm:space-y-0 sm:space-x-3 sm:space-x-reverse md:mt-0 md:flex-row md:space-x-3">
              <button
                type="button"
                className="text-gray-700 hover:bg-gray-50 focus:ring-offset-gray-100 inline-flex items-center justify-center rounded-md border border-gray bg-white px-4 py-2 text-sm font-medium shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
              >
                Disqualify
              </button>
              <button
            ...
            <div className="space-y-6 lg:col-span-2 lg:col-start-1">
              ...
              <section aria-labelledby="applicant-information-title">
                <div className="bg-white shadow sm:rounded-lg">
                  ...
                  <div className="border-t border-gray px-4 py-5 sm:px-6">
                    <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                      ...
                      <div className="sm:col-span-1">
                        ...
                        <dd className="text-gray-900 mt-1 text-sm">$120,000</dd>
                      </div>
                      <div className="sm:col-span-1">
                        <dt className="text-gray-500 text-sm font-medium">
                          Phone
                      ...
                      <div className="sm:col-span-2">
                        ...
                        <dd className="text-gray-900 mt-1 text-sm">
                          <ul
                            role="list"
                            className="divide-gray-200 divide-y rounded-md border border-gray"
                          >
                  ...
                  <div>
                    <a
                      href="#"
                      className="bg-gray-50 text-gray-500 hover:text-gray-700 block px-4 py-4 text-center text-sm font-medium sm:rounded-b-lg"
                    >
                        ...
                        <form action="#">
                          <div>
                            ...
                            <textarea
                              ...
                              name="comment"
                              rows={3}
                              className="focus:border-dark focus:ring-dark block w-full rounded-md border-gray shadow-sm sm:text-sm"
                      ...
                      <li key={item.id}>
                        <div className="relative pb-8">
                          {itemIdx !== timeline.length - 1 ? (
                            <span
                              className="absolute top-4 left-4 -ml-px h-full w-0.5 bg-gray"
                              aria-hidden="true"
                            />
                          ) : null}
                          <div className="relative flex space-x-3">
                            ...
                            <div className="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
                              ...
                              <div className="text-gray-500 whitespace-nowrap text-right text-sm">
